 ...
 * 
 */
@WebFault(name = "SecuredImsException", targetNamespace = "http://uimsv22.service.ims.schneider.com/")
    ...
    extends Exception
{
     ...
     * 
     * @return
     *     returns fault bean: com.uims.authenticatedUsermanager.SecuredImsException
     */
