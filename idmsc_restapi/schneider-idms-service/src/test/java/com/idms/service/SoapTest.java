...
public class SoapTest {
	...
	public static void getUser() throws Exception {
		URL url = new URL("https://ims-int.btsec.dev.schneider-electric.com/IMS-UserManager/UIMSV2/UserManager?wsdl");

		QName qname = new QName("http://uimsv2.impl.service.ims.schneider.com/", "UIMSV2_UserManagement");
