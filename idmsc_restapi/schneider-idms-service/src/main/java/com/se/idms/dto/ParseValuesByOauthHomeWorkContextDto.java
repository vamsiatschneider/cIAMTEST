...
//				? getValue(userProductDocCtx.read("$.").toString()) : getDelimeter());
		...
		/*userResponse.getCustomAttributes().setBusinessUnit(null != userProductDocCtx.read("$.")
				? getValue(userProductDocCtx.read("$.").toString()) : getDelimeter());*/
		...
		userResponse.getCustomAttributes().setCompanyAdditionalAddress(null != userProductDocCtx.read("$.companyAdditionalInfo")
		...
		userResponse.getCustomAttributes().setCompanyStateOrProvinceCode(null != userProductDocCtx.read("$.companyState")
		...
		/*userResponse.getCustomAttributes().setDivision(null != userProductDocCtx.read("$.annualRevenue")
				? getValue(userProductDocCtx.read("$.annualRevenue").toString()) : getDelimeter());*/
		...
		/*userResponse.getCustomAttributes().setTaxIdentificationNumber(null != userProductDocCtx.read("$.")
				? getValue(userProductDocCtx.read("$.").toString()) : getDelimeter());*/
		
//		userResponse.getCustomAttributes().setTitle(null != userProductDocCtx.read("$.title")
//				? getValue(userProductDocCtx.read("$.title").toString()) : getDelimeter());
	...
	public void parseValuesByOauthHomeContext(GetUserHomeByOauthResponse userResponse,
		...
		/*userResponse.getCustomAttributes().setTrustLevel(null != userProductDocCtx.read("$.")
				? getValue(userProductDocCtx.read("$.").toString()) : getDelimeter());
		userResponse.getCustomAttributes().setTrustStatus(null != userProductDocCtx.read("$.")
				? getValue(userProductDocCtx.read("$.").toString()) : getDelimeter());*/
	...
	public void parseValuesHomeContext(OpenAMGetUserHomeResponse userResponse, DocumentContext userProductDocCtx) {
		...
		/*String newmail= null != userProductDocCtx.read("$.newmail")
				? getValue(userProductDocCtx.read("$.newmail").toString()) : getDelimeter();
		if(null != newmail && !newmail.isEmpty()){
			userResponse.setEmail(newmail);
		}else{
