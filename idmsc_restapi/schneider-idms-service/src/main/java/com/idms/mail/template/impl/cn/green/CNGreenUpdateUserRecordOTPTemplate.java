...
public class CNGreenUpdateUserRecordOTPTemplate extends CNGreenDefaultTemplate {

	public CNGreenUpdateUserRecordOTPTemplate(EmailTemplateInput input) {
		super(input);
	}
...
//		return template;
		...
		String filePath = input.getConfiguration().getIDMS_USER_UPDATE_OTP_EMAILTEMPLATE_CN();
		EmailTemplate template = new EmailTemplate();
		template.setEmailTemplatePath(filePath);
		return template;
	}
