...
public class ENGreenEclipseRegistrationTemplate extends ENGreenDefaultTemplate {

	public ENGreenEclipseRegistrationTemplate(EmailTemplateInput input) {
		super(input);
	}
...
//		return template;
		...
		String filePath = input.getConfiguration().getPRM_ECLIPSE_USER_REGESTRATION_EMAILTEMPLATE_EN();
		EmailTemplate template = new EmailTemplate();
		template.setEmailTemplatePath(filePath);
		return template;
	}
