...
public class ENGreenAddEmailUserRecordTemplate extends ENGreenDefaultTemplate {
	
	public ENGreenAddEmailUserRecordTemplate(EmailTemplateInput input) {
		super(input);
	}
...
//		String filePath = _instance.getConfiguration("user.add.email.template.en");
