...
public class CNGreenAddEmailUserRecordTemplate extends CNGreenDefaultTemplate {
	
	public CNGreenAddEmailUserRecordTemplate(EmailTemplateInput input) {
		super(input);
	}
...
//		String filePath = _instance.getConfiguration("user.add.email.template.cn");
