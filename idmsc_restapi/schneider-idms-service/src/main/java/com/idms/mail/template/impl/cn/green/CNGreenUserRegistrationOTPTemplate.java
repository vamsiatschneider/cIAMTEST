...
public class CNGreenUserRegistrationOTPTemplate extends CNGreenDefaultTemplate {

	public CNGreenUserRegistrationOTPTemplate(EmailTemplateInput input) {
		super(input);
	}
...
//		String filePath = _instance.getConfiguration("user.registration.withpwd.otp.email.template.cn");
