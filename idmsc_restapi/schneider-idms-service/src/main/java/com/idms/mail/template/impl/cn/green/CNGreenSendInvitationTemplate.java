...
public class CNGreenSendInvitationTemplate extends CNGreenDefaultTemplate {

	public CNGreenSendInvitationTemplate(EmailTemplateInput input) {
		super(input);
	}
...
//		String filePath = _instance.getConfiguration("send.invitation.email.template.cn");
