...
public class OTPGreenTemplatePlaceholderCNSubstitutor extends TemplatePlaceholderSubstitutor {

	public OTPGreenTemplatePlaceholderCNSubstitutor(DynamicEmailTemplateInput input, OpenDJAttributes openDJAttributes) {
