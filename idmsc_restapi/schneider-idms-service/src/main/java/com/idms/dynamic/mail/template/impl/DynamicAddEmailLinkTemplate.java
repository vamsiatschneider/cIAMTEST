...
public class DynamicAddEmailLinkTemplate {

	private DynamicEmailTemplateInput input;
	
	public DynamicAddEmailLinkTemplate(DynamicEmailTemplateInput input) {
		this.input = input;
	}
...
//		String filePath = _instance.getConfiguration("user.add.email.template");
//		EmailTemplate template = new EmailTemplate();
//		template.setEmailTemplatePath(filePath);
//		return template;
		
		String filePath = input.getConfiguration().getIDMS_USER_ADD_EMAILTEMPLATE();
