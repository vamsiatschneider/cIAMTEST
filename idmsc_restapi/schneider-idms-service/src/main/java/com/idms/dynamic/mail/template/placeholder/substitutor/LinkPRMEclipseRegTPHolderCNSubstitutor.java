...
public class LinkPRMEclipseRegTPHolderCNSubstitutor extends LinkTemplatePlaceholderCNSubstitutor {
	
	public LinkPRMEclipseRegTPHolderCNSubstitutor(DynamicEmailTemplateInput input,
