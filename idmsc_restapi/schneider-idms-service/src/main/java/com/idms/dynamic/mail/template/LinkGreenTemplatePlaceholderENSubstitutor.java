...
public class LinkGreenTemplatePlaceholderENSubstitutor extends TemplatePlaceholderSubstitutor {

	public LinkGreenTemplatePlaceholderENSubstitutor(DynamicEmailTemplateInput input, OpenDJAttributes openDJAttributes) {
