...
public class OTPBlueTemplatePlaceholderENSubstitutor extends TemplatePlaceholderSubstitutor {

	public OTPBlueTemplatePlaceholderENSubstitutor(DynamicEmailTemplateInput input, OpenDJAttributes openDJAttributes) {
