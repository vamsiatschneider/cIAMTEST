...
public class LinkGreenPRMInterRegTPHolderCNSubstitutor extends LinkGreenTemplatePlaceholderCNSubstitutor {
	
	public LinkGreenPRMInterRegTPHolderCNSubstitutor(DynamicEmailTemplateInput input,
