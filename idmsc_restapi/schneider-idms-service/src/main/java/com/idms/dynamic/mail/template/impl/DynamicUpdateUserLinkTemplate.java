...
public class DynamicUpdateUserLinkTemplate {

	private DynamicEmailTemplateInput input;
	
	public DynamicUpdateUserLinkTemplate(DynamicEmailTemplateInput input) {
		this.input = input;
	}
...
//		String filePath = _instance.getConfiguration("user.update.email.template");
//		EmailTemplate template = new EmailTemplate();
//		template.setEmailTemplatePath(filePath);
//		return template;
		
		String filePath = input.getConfiguration().getIDMS_USER_UPDATE_EMAILTEMPLATE();
