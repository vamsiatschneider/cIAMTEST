...
public class DynamicResetPasswordOTPTemplate {

	private DynamicEmailTemplateInput input;
	
	public DynamicResetPasswordOTPTemplate(DynamicEmailTemplateInput input) {
		this.input = input;
	}
...
//		String filePath = _instance.getConfiguration("user.reset.password.otp.email.template");
//		EmailTemplate template = new EmailTemplate();
//		template.setEmailTemplatePath(filePath);
//		return template;
		
		String filePath = input.getConfiguration().getIDMS_USER_RESET_PASSWORD_OTP_EMAILTEMPLATE();
