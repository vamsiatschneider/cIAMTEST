...
public class UIMSUserManagerSoapServicePreProd implements UIMSUserManagerSoapService<UserManagerUIMSV2, UserV5, UserManagerUIMSV22> {
	 ...
	 * Logger instance.
	 */
	private static final Logger LOGGER = LoggerFactory.getLogger(UIMSUserManagerSoapServicePreProd.class);
	...
	public boolean updateUIMSUser(String fedId, UserV5 user, String vnew) throws MalformedURLException {
		...
		try {
			...
			LOGGER.error("Exception in updateUIMSUser()::" + e.getMessage());
			e.printStackTrace();
		}	
			...
			Callable<Boolean> callableCompany = new Callable<Boolean>() {
				public Boolean call() throws Exception {
					...
					if (null != createdCompanyFedId) {
						...
						if (null != goDigitalValue && goDigitalValue
