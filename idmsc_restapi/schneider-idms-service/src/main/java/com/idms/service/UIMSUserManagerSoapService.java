				...
				public Boolean call() throws Exception {
					...
					if(null == company.getFederatedId() && null != companyFedId){
						...
						if(checkUserPrimaryContact.equalsIgnoreCase("true")){
							...
							&& null != company.getOrganizationName() && !company.getOrganizationName().isEmpty()){
					...
					} else if(null != company.getOrganizationName() && !company.getOrganizationName().isEmpty()
							&& null != company.getFederatedId() && !company.getFederatedId().isEmpty()){
